...
int main()
{
    ...
    s1.deposit(10000 - s1.getBalance());

    s1.display();

    Account a1(3001, 8000);
    PremiumSavings p2(3002, 7000, 6, 150);

    s1.deposit(-500);   // logically wrong but syntactically allowed

    cout << "Interest added via method already." << endl;
